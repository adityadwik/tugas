			...
			<tbody>
				...
				<?php foreach ($data as $key => $value): ?>
					<tr style="text-align: center">
						...
						<td><a href="index.php?halaman=ubah_karyawan&id=<?php echo $value['id_karyawan'];?>"  style="text-decoration: underline; color: blue;" >Ubah</a></td>
						<td><a href="index.php?halaman=hapus_karyawan&id=<?php echo $value['id_karyawan'];?>" style="text-decoration: underline; color: red">Hapus</a></td>
					</tr>
				<?php endforeach ?>
			</tbody>
		</table>
			...
			<div class="modal-dialog modal-dialog-centered" role="dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="ModalTitle">Pengisian Data Karyawan</h5>
					...
					<div class="modal-body" id="insert_form">
						<form method="post">
							...
							<div class="form-group">
								<input style="margin-right: 10px" type="submit" name="tambah" id="tambah" value="Tambah" class="btn btn-primary" />
								<?php 
